...
if(isset($_POST['delete_file']))
{
    $filename = $_POST['file_name'];
    unlink('ImageGallery/'.$filename);
    if(file_exists('ImageGallery/thumbs/'.$filename))
    {
    unlink('ImageGallery/thumbs/'.$filename);
  }
}
?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form style="text-align: center;" method="post" action="add_gallery.php" enctype="multipart/form-data">
              ...
              <div class="col-md-6 px-1 pt-1">
                ...
                <div class="col-md-12">
                  <label>Enter Title</label>
                      <input type="text" name="title" id="check" class="form-control" />
                  </div>
                </div>
                <div class="row">
                <div class="col-md-12">
            ...
            <div id="wrapper">
                ...
                <div id="file_div">
                    ...
                    if ($dir = opendir($folder))
                    {
                        ...
                        {
                            echo "<p>".$file."</p>";
                            //echo "<form method='post' action='Add_Gallery.php'>";
