...
<body class="">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add RTI</h4>
                  <p class="card-category"></p>
                </div>
                <div class="card-body" style="overflow-x: auto;">
                  <form style="text-align: center;" method="post" action="add_info.php" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea rows="4" cols="50" class="form-control" name="description" id="check"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
  ...
  <?php $results = mysqli_query($link, "SELECT * FROM t_right_to_act"); ?>
  <?php while ($row = mysqli_fetch_array($results)) { ?>
    <tr>
      ...
      <td>
        <a href="add_info.php?del=<?php echo $row['SRNO']; ?>" class="del_btn">Delete</a>
      </td>
    </tr>
  <?php } ?>
</table>
