...
$results = mysqli_query($link, "SELECT SRNO,MONTH,YEAR,DESCRIPTION,NAME,SIZE,DOWNLOADS,RECORD_STATUS,RECORD_CREATED_ON FROM t_right_to_act");

if (isset($_GET['del'])) {
  $id = $_GET['del'];
  mysqli_query($link, "DELETE FROM t_right_to_act WHERE SRNO=$id");
  $_SESSION['message'] = "Address deleted!"; 
  header('location: add_traffic_edu.php');
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add Traffic Education</h4>
                  <p class="card-category"></p>
                </div>
                <div class="card-body">
                  <form style="text-align: center;" method="post" action="add_traffic_edu.php" enctype="multipart/form-data">
              ...
              <div class="col-md-6 px-1 pt-1">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea rows="4" cols="50" class="form-control" id="check"></textarea>
                    </div>
                  </div>
                </div>
