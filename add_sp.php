            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add SP</h4>
                  <p class="card-category"></p>
                </div>
                <div class="card-body">
                  <form style="text-align: center;" method="post" action="add_sp.php" enctype="multipart/form-data">
            <div class="row border rounded container-fluid mx-0 pb-1">
              ...
              <div class="col-md-6 px-1 pt-1">
                <div class="form-group">
                  ...
                  <input type="text" name="spname" width="250px" id="check" class="form-control" />
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="date" name="durationfrom" class="form-control">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input type="date" name="durationto" class="form-control">
                  </div>
                </div>
